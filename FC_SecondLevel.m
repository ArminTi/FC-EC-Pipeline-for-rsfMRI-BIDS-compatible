function FC_SecondLevel(Datadir)

% In this stage you can simply use the bellow code; Personally I prefer to
% work with GUI for second level; Therefore, I call the conn and project to
% go further
